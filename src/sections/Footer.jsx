    ...
    <footer className="max-container ">
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
         <a href="">
          ...
          <span className="text-2xl font-bold font-palanquin" style={{ color: "#FFFFFF" }}>
            Wonasi
          </span>
          </a> 
          <p className="mt-6 text-base leading-7 font-montserrat text-white-400 sm:max-w-sm">
            Get shoes ready for the new tem at your nearest Nike store.
                  ...
                  <div key={section}>
                    ...
                    <ul>
                      {section.links.map((link) => (
                        <li className="mt-3 text-white-400 font-monsterrat text-base leading-normal
      ...
      <div className="flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center">
          <div className="flex flex-1 justify-start items-center gap-2 font-montserrat cursor-pointer">
               ...
               />
                <p>2024 Wonasi. All Rights Reserved</p>
          </div>
